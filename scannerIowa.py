#This script is just for harvesting from the Iowa DOT (http://public-iowadot.opendata.arcgis.com/data.json)
...
Changed Feb 1, 2022
The Iowa DOT portal seems to have unexpected titles, so I removed all the logic pertaining to finding keywords and dates in titles
...
def check_duplicates(df):
    ...
    for _,row in df.iterrows():
        ...
        if ID not in item_dict:
            item_dict[ID] = alternativeTitle+'|'+spatialCoverage
